...
export const InfoTextAndImage: FC = () => {
  return (
    ...
    >
      ...
      {/* <img
        src={
          "https://images.unsplash.com/photo-1535580284089-799de74e2d1b?q=80&w=2662&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
        alt=''
      /> */}
