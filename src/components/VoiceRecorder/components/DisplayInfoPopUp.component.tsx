...
export const DisplayInfoPopUp: FC = () => {
  return (
    <div className='flex items-center flex-col gap-2 p-4  rounded-md shadow-lg absolute top-56 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border  text-black bg-gray-200 '>
